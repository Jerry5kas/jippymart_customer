...
<div class="container h-auto space-y-12 py-12">
    <h2 class="max-w-2xl mx-auto text-3xl font-bold text-red-500 uppercase mb-2">Account Settings</h2>
    <div class="">
        <div class="max-w-2xl mx-auto bg-white shadow-md rounded-2xl p-6 py-16 ">
            
           <h1 class="text-2xl font-bold mb-6">Jippy Mart Customer and Restaurant App – Data Deletion Request</h1>
            ...
            <div class="text-sm text-gray-700 mb-4">
                ...
                <ol class="list-decimal list-inside space-y-1 pl-4">
                    <li>Go to <strong>Bottom Navigation bar</strong> from the <strong>Home</strong> page.</li>
