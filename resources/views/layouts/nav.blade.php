<nav id="main-nav">
    <ul class="second-nav">
        ...
        <li><a href="{{url('transactions')}}"><i class="feather-list mr-2"></i> {{trans('lang.my_transactions')}}</a>
        </li>
        <li><a href="{{url('buy-gift-card')}}"><i class="feather-gift mr-2"></i> {{trans('lang.buy_gift_card')}}</a>
        </li>
        <li><a href="{{url('giftcards')}}"><i class="feather-gift mr-2"></i> {{trans('lang.my_gift_cards')}}</a>
        </li>
        <li><a href="{{route('favorites')}}"><i class="feather-heart mr-2"></i> {{trans('lang.favorite_stores')}}</a></li>
        <li><a href="{{url('favorite-products')}}"><i class="feather-heart mr-2"></i> {{trans('lang.favorite_products')}}</a></li>
        <li><a href="{{url('delivery-address')}}"><i class="feather-book mr-2"></i> {{trans('lang.address_book')}}</a>
        </li>
        <li><a href="{{url('restaurants')}}"><i class="feather-list mr-2"></i> {{trans('lang.all_restaurants')}}</a>
        </li>
        <li class="dine_in_menu hide_tab" style="display:none;"><a href="{{url('restaurants')}}?dinein=1"><i
                        class="feather-list mr-2"></i>
        ...
        <li class="dine_in_menu hide_tab" style="display:none;"><a href="{{url('restaurants')}}?dinein=1"><i
                        class="feather-list mr-2"></i>{{trans('lang.dine_in_restaurants')}}</a></li>
