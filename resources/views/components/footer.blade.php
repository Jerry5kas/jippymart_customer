<footer class="bg-gradient-to-b from-[#E8F8DB] to-white border-t border-gray-200">
    <div class="w-full sm:w-[90%] mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div class="space-y-6">
            ...
            <p class="text-xs text-gray-400">© 2025 Mart Marketplace Private Limited. All rights reserved.</p>
        </div>
        ...
        <div class="space-y-5 text-center md:text-left">
            <h3 class="text-gray-900 font-semibold text-base">Download App</h3>
            <a href="#" class="flex items-center justify-center md:justify-start w-full border rounded-lg px-4 py-3 shadow-sm hover:shadow-md hover:bg-gray-50 transition">
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Play Store" class="h-12">
            </a>
            <a href="#" class="flex items-center justify-center md:justify-start w-full border rounded-lg px-4 py-3 shadow-sm hover:shadow-md hover:bg-gray-50 transition">
    ...
    <!-- Bottom Strip -->
    <div class="border-t border-gray-200 mt-6 py-4 text-center text-xs text-gray-500">
        Built with <span class="text-red-500">♥</span> by Mart Team
    </div>
</footer>
